...
## Control Parameters
```{r}
df = read.table("https://raw.githubusercontent.com/BivinSadler/MSDS_6306_Doing-Data-Science/Master/Unit%205/yob2016.txt",stringsAsFactors = FALSE,header = FALSE,sep = ";")
